...
public class AssetsService {
  ...
  public void changeAssetQuantity(int assetId, int quantity, Constants.changeType changType) throws IOException {
  ...
  public void changeAssetQuantity(int assetId, int quantity) throws IOException {
    Asset asset = assetsRepository.findByAssetId(assetId);
